...
4. Use Buffer MCP: create a YouTube draft post with the chosen title and yt_description, scheduled for schedule_date
5. Use Buffer MCP: create an Instagram draft post with the chosen ig caption, scheduled for schedule_date
6. If LinkedIn was requested: use Buffer MCP to create a LinkedIn draft, scheduled for schedule_date
...
10. Send confirmation to George via Slack MCP:
    ✅ Scheduled for [schedule_date]: *[chosen_title]*
